...
EXPORT_FUNC(_PyLong_AsInt)
EXPORT_FUNC(PyObject_GetBuffer)

EXPORT_FUNC(PyBuffer_Release)
EXPORT_FUNC(_PyNumber_Index)
EXPORT_FUNC(_PyArg_NoKeywords)
EXPORT_FUNC(_PyArg_NoPositional)
EXPORT_FUNC(_PyArg_BadArgument)
EXPORT_FUNC(_PyArg_CheckPositional)
EXPORT_FUNC(_PyArg_UnpackKeywords)

EXPORT_FUNC(PyBuffer_IsContiguous)
EXPORT_FUNC(_PyDict_SetItemId)
